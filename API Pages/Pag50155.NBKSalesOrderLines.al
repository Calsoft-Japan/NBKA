...
page 50155 NBK_SalesOrderLines
{
    APIGroup = 'powerbipages';
    APIPublisher = 'nbk_calsoft';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'nbkSalesOrderLines';
    DelayedInsert = true;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field(discountRate; Rec."Discount Rate")
                {
                ...
                field(grossProfitRate; Rec."Gross Profit Rate %")
                {
                    Caption = 'Gross Profit Rate %';
                }
                field(grossProfitRate60; Rec."Gross Profit Rate < 60%")
                {
                ...
                field(leadTimeText; Rec."Lead Time text")
                {
                    Caption = 'Lead Time';
                }
                ...
                field(originalDiscount; Rec."Original Discount %")
                {
                    Caption = 'Original Discount %';
                }
                field(originalPrice; Rec."Original Price")
                {
                ...
                field(quantityMax; Rec."Quantity (max)")
                {
                    Caption = 'Quantity (max)';
                }
                field(quantityMin; Rec."Quantity (min)")
                {
                ...
                field(shippingDate; Rec."Shipping Date")
                {
                ...
                field(specialProduct; Rec."Special Product")
                {
                ...
                field(webProductNo; Rec."Web Product No.")
                {
