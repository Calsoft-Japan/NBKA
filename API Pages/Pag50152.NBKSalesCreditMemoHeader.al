...
page 50152 NBK_SalesCreditMemoHeader
{
    ...
    ApplicationArea = All;
    DelayedInsert = false;
    Caption = 'nbkSalesCreditMemoHeader';
    EntityName = 'nbk_salescreditmemoheader';
    EntitySetName = 'nbk_salescreditmemoheader';
    PageType = API;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                part(lines; NBK_SalesCreditMemolines)
                {
                    EntityName = 'nbk_salescreditmemolines';
                    EntitySetName = 'nbk_salescreditmemolines';
                    ApplicationArea = all;
                    Visible = true;
                    Caption = 'lines';
