...
page 50151 NBK_Items
{
    ...
    Caption = 'nbkItems';
    DelayedInsert = true;
    EntityName = 'nbk_items';
    EntitySetName = 'nbk_items';
    PageType = API;
    SourceTable = Item;
    ODataKeyFields = "No.";
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field(satMaterialType; Rec."SAT Material Type")
                {
                ...
                field(whiPictureModifiedOn; Rec."WHI Picture Modified On")
                {
                    Caption = 'Warehouse Insight Picture Modified On';
                }
