...
page 50156 Nbk_SalesInvoiceHeader
{
    APIGroup = 'powerbipages';
    APIPublisher = 'nbk_calsoft';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'nbkSalesInvoiceHeader';
    DelayedInsert = false;
    EntityName = 'nbk_salesinvoiceheader';
    EntitySetName = 'nbk_salesinvoiceheader';
    PageType = API;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field(cdoEmailLog; Rec."CDO Email Log")
                {
                    Caption = 'Email Log';
                }
                ...
                field(cdoNoOfEDocsCreated; Rec."CDO No. of E-Docs created")
                {
                    Caption = 'No. of E-Docs created';
                }
                ...
                part(lines; NBK_SalesInvoiceLines)
                {
