...
report 50107 "Purchase Order New"
{
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Shiptoaddlbl; Shiptoaddlbl)
                    {
                    }
                    ...
                    column(PaymentTermsDescLbl; PaymentTermsDescLbl)
                    {
                    }
                    ...
                    column(Currcode_PurchaseHeader; "Purchase Header"."Currency Code")
                    {
                    }
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        column(ProductNolbl; ProductNolbl)
                        {
                        }
            ...
            begin
                ...
                FormatAddress.GetCompanyAddr("Purchase Header"."Responsibility Center", RespCenter, CompanyInformation, CompanyAddress);
                ...
                if "Posting Date" <> 0D then
                    ...
                    UseDate := WorkDate();
                FormatDocument.SetPaymentMethod(PaymentMethod, "Purchase Header"."Payment Method Code", "Purchase Header"."Language Code");
