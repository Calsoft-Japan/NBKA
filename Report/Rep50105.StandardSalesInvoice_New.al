...
report 50105 "Standard Sales - Invoice New"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(Totalamountduelbl; Totalamountduelbl)
            {
            }
            column(RemittancePageLbl; RemittancePageLbl)
            {
            }
            column(PaymentInstructionslbl; PaymentInstructionslbl)
            {
            }
            column(Salesinvlbl; Salesinvlbl)
            {
            }
            ...
            column(ACHPaymentWireInslbl; ACHPaymentWireInslbl)
            {
            }
            column(CheckPaymentLbl; CheckPaymentLbl)
            {
            }
            column(CompanyInfoBankaccountNo; CompanyInfo."Bank Account No.")
            {
            }
            column(CompanyInfoPayRoutNo; CompanyInfo."Payment Routing No.")
            {
            }
    ...
    var
        ...
        BuyersNamelbl: Label 'Buyer’s Name';
        Totaltaxlbl: Label 'Total Tax';
        Totalamountduelbl: Label 'Total Amount Due';
        RemittancePageLbl: Label 'Remittance Page';
        PaymentInstructionslbl: Label 'Payment Instructions';
        Salesinvlbl: Label 'Sales Invoice';
        SalesShipmentHeader: Record "Sales Shipment Header";
        TempSaleshipmentLine: Record "Sales Shipment Line" temporary;
        CheckPaymentLbl: Label 'Check Payment';
        ACHPaymentWireInslbl: Label 'ACH Payment & Wire Instructions';
