...
report 50103 "Standard Sales -Order Conf.New"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(SalesOrderConfirmationLbl; SalesOrderConfirmationLbl)
            {

            }
            column(OrderFromLbl; OrderFromLbl)
            {
            ...
            column(PaymentTerms_des; PaymentTerms.Description)
            {

            }
            column(Salesheader_CurrencyCode; "Currency Code")
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(Shippingdatelbl; Shippingdatelbl)
                {
                }
    ...
    var
        ...
        SalesOrderConfirmationLbl: Label 'Sales Order Confirmation';
        OrderFromLbl: Label 'Order From';
        ...
        Shippingdatelbl: Label 'Shipping Date';
